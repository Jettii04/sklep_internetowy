    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <?php
                ...
                $noi = $pdo->prepare("SELECT COUNT(*) FROM category");
                $noi->execute();
                ...
                try {
                    $categories = $pdo->prepare("SELECT * FROM category where name like '%".$_GET['search']."%' ORDER BY category_id ASC LIMIT ".$nOnpage." OFFSET ".$offset);
                    $categories->execute();
                ...
                foreach($categories as $category){
                    echo '
                        <tr>
                            ...
                            <td>'.$category['name'].'</td>
                            <td>
                                <a href="javascript:edit('."'".$category['category_id']."'".')">
                            ...
                            <td>
                            <a href="javascript:remove('."'".$category['category_id']."'".')">
