...
if(isset($_POST['name'])){
    try {
        $update = $pdo->prepare("INSERT INTO payment_methods (name) values('".htmlspecialchars($_POST['name'])."')");
        $update->execute();
...
<head>
    <meta charset="utf-8">
    <title>Sposoby płatności - Dodak</title>
