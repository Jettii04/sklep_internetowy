    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <?php
                ...
                $noi = $pdo->prepare("SELECT COUNT(*) FROM payment_methods");
                $noi->execute();
                ...
                try {
                    $categories = $pdo->prepare("SELECT * FROM payment_methods where name like '%".$_GET['search']."%' ORDER BY payment_id ASC LIMIT ".$nOnpage." OFFSET ".$offset);
                    $categories->execute();
                ...
                foreach($categories as $category){
                    echo '
                        <tr>
                            ...
                            <td>'.$category['name'].'</td>
                            <td>
                                <a href="javascript:edit('."'".$category['payment_id']."'".')">
                            ...
                            <td>
                            <a href="javascript:remove('."'".$category['payment_id']."'".')">
...
<?php include("../../scripts/footer.php")?>
    ...
    <script type="text/javascript">
        ...
        function remove(item){
            var id=item;
            $.ajax({
                url: "../../scripts/remove_payment.php",
                method: 'POST',
                data: {
                    id: id
                }
