...
if(isset($_POST['name'])){
    try {
        $update = $pdo->prepare("UPDATE payment_methods set name='".htmlspecialchars($_POST['name'])."' where payment_id=".htmlspecialchars($_GET['id']));
        $update->execute();
...
<head>
    <meta charset="utf-8">
    <title>Sposoby płatności - Edytuj</title>
...
<div class="container-fluid p-0 d-flex h-100">
    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <h2>Sposoby płatności - Edytuj</h2> 
            <hr>
            </div>
            ...
            <?php
                try {
                    $categories = $pdo->prepare("SELECT * FROM payment_methods where payment_id=".htmlspecialchars($_GET['id']));
                    $categories->execute();
                }catch (PDOException $e) {
                    echo 'Nie udało się odczytać danych z bazy';
                    //exit();
