    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <?php
                ...
                $noi = $pdo->prepare("SELECT COUNT(*) FROM items");
                $noi->execute();
                ...
                try {
                    $items = $pdo->prepare("SELECT * FROM items where name like '%".$_GET['search']."%' ORDER BY item_id ASC LIMIT ".$nOnpage." OFFSET ".$offset);
                    $items->execute();
                ...
                foreach($items as $item){
                    echo '
                        ...
                        <div class="row mt-2 mb-2 d-flex align-items-center">
                                ...
                                <div class="col col-lg-1 mt-2 mt-lg-0">
                                    <a style="text-decoration: none" href="javascript:edit('."'".$item['item_id']."'".')">
                    ...
                    try {
                        $images = $pdo->prepare("SELECT image FROM item_images where item_id=".$item['item_id']);
                        $images -> execute();
                    }catch (PDOException $e) {
                        echo 'Nie udało się odczytać danych z bazy';
                        //exit();
                    ...
                    foreach($images as $image){
                        echo '
                            <img class="cart-item-img-sm ms-3" src="data:image;base64,'.base64_encode($image['image']).'" alt="Zdjęcie produktu">
                        ';
                    }
