...
if(isset($_POST['submit'])){
    try {
        ...
        $update = $pdo->prepare("INSERT INTO items (name,price,short_description,description,category) values (:name,:price,:short_description,:description,:category)");
        $update->execute($data);
...
<div class="container-fluid p-0 d-flex h-100">
    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <tbody>
                <tr>
                    <td><input type="text" id="name" name="name" class="form-control" placeholder="Nazwa..." value="" required></td>
                    <td><input type="text" id="price" name="price" class="form-control" placeholder="Cena..." value="" required></td>
                    <td><input type="text" id="short_description" name="short_description" class="form-control" placeholder="Krótki opis..." value="" required></td>
                    <td><input type="text" id="description" name="description" class="form-control" placeholder="Opis..." value="" required></td>
                    <?php
                        echo'
