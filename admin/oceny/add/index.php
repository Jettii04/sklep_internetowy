...
if(isset($_POST['submit'])){
    try {
        ...
        $update = $pdo->prepare("INSERT INTO reviews (item_id,name,surname,rating,description) values (:item_id,:name,:surname,:rating,:description)");
        $update->execute($data);
    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="number" id="item_id" name="item_id" class="form-control" placeholder="Id produktu..." min="1" step="1" value="" required></td>
                    <td><input type="text" id="name" name="name" class="form-control" placeholder="Imię..." value="" maxlength="50" required></td>
                    <td><input type="text" id="surname" name="surname" class="form-control" placeholder="Nazwisko..." value="" maxlength="60" required></td>
                    <td><input type="number" id="rating" name="rating" class="form-control" min="1" step="1" max="5" value="" required></td>
                    <td><textarea type="text" id="description" name="description" class="form-control" placeholder="Treść..." value=""></textarea></td>
                </tr>
