    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <?php
                ...
                $noi = $pdo->prepare("SELECT COUNT(*) FROM order_satus");
                $noi->execute();
                ...
                try {
                    $categories = $pdo->prepare("SELECT * FROM order_satus where name like '%".$_GET['search']."%' ORDER BY status_id ASC LIMIT ".$nOnpage." OFFSET ".$offset);
                    $categories->execute();
                ...
                foreach($categories as $category){
                    echo '
                        <tr>
                            ...
                            <td>'.$category['name'].'</td>
                            <td>
                                <a href="javascript:edit('."'".$category['status_id']."'".')">
                            ...
                            <td>
                            <a href="javascript:remove('."'".$category['status_id']."'".')">
