...
if(isset($_POST['submit'])){
    try {
        ...
        $update = $pdo->prepare("INSERT INTO users (login,email,name,surname,phone,road,city,postal_code,house_number,employee) values (:login,:email,:name,:surname,:phone,:road,:city,:postal_code,:house_number,'1')");
        $update->execute($data);
