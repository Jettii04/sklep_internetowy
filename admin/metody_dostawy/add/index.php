...
if(isset($_POST['submit'])){
    try {
        $update = $pdo->prepare("INSERT INTO delivery_method (name,price) values('".htmlspecialchars($_POST['name'])."','".htmlspecialchars($_POST['price'])."')");
        $update->execute();
    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="text" id="name" name="name" class="form-control" placeholder="Nazwa..." value="" maxlength="50" required></td>
                    <td><input type="text" id="price" name="price" class="form-control" placeholder="Cena w zł..." value="" pattern="[\d]{1,}[\.]{0,1}[\d]{0,2}" required></td>
                </tr>
