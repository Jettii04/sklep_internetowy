    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <?php
                ...
                $noi = $pdo->prepare("SELECT COUNT(*) FROM delivery_method");
                $noi->execute();
                ...
                try {
                    $categories = $pdo->prepare("SELECT * FROM delivery_method where name like '%".$_GET['search']."%' ORDER BY delivery_id ASC LIMIT ".$nOnpage." OFFSET ".$offset);
                    $categories->execute();
                ...
                foreach($categories as $category){
                    echo '
                        <tr>
                            ...
                            <td>
                            <a href="javascript:remove('."'".$category['delivery_id']."'".')">
