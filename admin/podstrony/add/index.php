...
if(isset($_POST['submit'])){
    try {
        $update = $pdo->prepare("INSERT INTO info_sites (header,body) values('".htmlspecialchars($_POST['header'])."','".htmlspecialchars($_POST['body'])."')");
        $update->execute();
    ...
    <div class="bg-light flex-fill table-responsive">
        ...
        <div class="p-4">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="text" id="header" name="header" class="form-control" placeholder="Nagłówek..." value="" maxlength="50" required></td>
                    <td><textarea id="body" name="body" class="form-control" placeholder="Treść..." required></textarea></td>
                </tr>
