<div id="bdSidebar" class="d-flex flex-column flex-shrink-0 p-3 bg-dark text-white offcanvas-md offcanvas-start">
    <ul class="mynav nav nav-pills flex-column mb-auto">
        <li class="nav-item mb-1">
            <a href="https://chalimoniukmikolaj.infinityfreeapp.com/admin/zamowienia/" class="nav-link">
                Zamówienia
            </a>
        </li>
        <li class="nav-item mb-1">
            <a href="https://chalimoniukmikolaj.infinityfreeapp.com/admin/produkty/" class="nav-link">
                Produkty
            </a>
        </li>
        <li class="nav-item mb-1">
            <a href="https://chalimoniukmikolaj.infinityfreeapp.com/admin/klienci/" class="nav-link">
                klienci
            </a>
        </li>
        <li class="nav-item mb-1">
