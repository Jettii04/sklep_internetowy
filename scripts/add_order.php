...
if(isset($_SESSION['login'])){
    ...
    // tworzenie zamówienia
    try {
        $c = $pdo->prepare("INSERT INTO orders (order_id,order_status,postal_code,city,road,house_number,payment_method,delivery_method,time) VALUES (:order_id,:order_status,:postal,:city,:road,:house,:pay,:deliv,:time)");
        $c->execute($data);
    }catch (PDOException $e) {
        echo 'Wystąpił błąd';
        //exit();
